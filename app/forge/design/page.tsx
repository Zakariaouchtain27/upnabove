...
export const metadata: Metadata = {
  title: "Design Challenges | The Forge",
  description: "Prove your UI/UX and product design prowess in high-stakes arenas.",
};

export default async function ForgeDesignCategory() {
  const supabase = await createClient();
  const { data: challenges } = await supabase
    .from("forge_challenges")
    .select("*")
    .eq("challenge_type", "design")
    ...
    <div className="min-h-screen bg-white dark:bg-[#05050a] pt-24 pb-32">
       <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-16 text-center max-w-3xl mx-auto">
             <h1 className="text-5xl font-black uppercase tracking-tight text-zinc-900 dark:text-white mb-4">Design Arenas</h1>
             <p className="text-muted-foreground font-mono">
                From high-fidelity UI engineering to conceptual UX overhauls. 
                Below are the active and upcoming design deployments currently open for ranking in The Forge.
             </p>
          </div>
