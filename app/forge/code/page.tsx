...
export const metadata: Metadata = {
  title: "Code Bounties | The Forge",
  description: "Prove your full-stack, infrastructure, and algorithmic engineering abilities in live arenas.",
};

export default async function ForgeCodeCategory() {
  const supabase = await createClient();
  const { data: challenges } = await supabase
    .from("forge_challenges")
    .select("*")
    .eq("challenge_type", "code")
       ...
       <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-16 text-center max-w-3xl mx-auto">
             ...
             <p className="text-muted-foreground font-mono">
                From scalable backend architectures to pixel-perfect frontend engineering. 
                Below are the active and upcoming code deployments currently open for ranking in The Forge.
             </p>
          </div>
